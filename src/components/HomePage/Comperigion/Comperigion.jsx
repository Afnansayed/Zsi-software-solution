                ...
                {/* row 1 */}
                 {
                  ...
                  <td className="border-x-2 border-[#fff]"> 
                      {
                        data?.social_media_package && <p className="text-green-600 w-[30%] mx-auto"><IoCheckmarkDoneCircle /></p>

                      }
                      {
                        !data?.social_media_package && <p className="text-red-500 w-[30%] mx-auto"><RxCross2 /></p>
                      }
                  </td>
                  {/* col-3 */}
                  <td className="border-x-2 border-[#fff]"> 
                      {
                        data?.seo_package && <p className="text-green-600 w-[30%] mx-auto"><IoCheckmarkDoneCircle /></p>

                      }
                      {
                        !data?.seo_package
                        && <p className="text-red-500 w-[30%] mx-auto"><RxCross2 /></p>
                      }
                  </td>
                  {/* col-4 */}
                  <td className="border-x-2 border-[#fff]"> 
                      {
                        ...
                        && <p className="text-green-600 w-[30%] mx-auto"><IoCheckmarkDoneCircle /></p>
                  ...
                  <td className="border-x-2 border-[#fff]"> 
                      {
                        data?.
                        gold_package && <p className="text-green-600 w-[30%] mx-auto"><IoCheckmarkDoneCircle /></p>

                      }
                      {
                        !data?.
                        gold_package && <p className="text-red-500 w-[30%] mx-auto"><RxCross2 /></p>
                      }
                  </td>
                  {/* col-7 */}
                  <td className="border-x-2 border-[#fff]"> 
